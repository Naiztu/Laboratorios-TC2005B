...
export default function Card2({ data }) {
  ...
  return (
    <a href={link} target="_blank" rel="noreferrer" className="w-[320px] mx-4 my-8">
      <div className="bg-neutral/70 rounded-xl h-[190px] hover:shadow-xl overflow-hidden relative">
