...
export default function Laboratorio21() {
    return (
        <Layaout>
            <div className="mx-auto w-11/12">
                <h1 className="title">
                    Creación de Consultas Utilizando SQL con Funciones Agregadas y
                    Sub-consultas
                </h1>
                <div className=" w-11/12 md:w-5/12 mb-10 mx-auto">
                    <a
                        target={"_blank"}
                        rel="noreferrer"
                        href="https://github.com/Naiztu/Laboratorios-TC2005B/blob/master/laboratorio21/Consultas%20Utilizando%20SQL%20con%20Funciones%20Agregadas%20y%20Sub-consultas.pdf"
                    >
                        <svg
