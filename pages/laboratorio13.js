      ...
      <div className="pt-16">
        <div className="w-11/12 mx-auto">
          ...
          <div>
            ...
            <ul className="w-10/12 mx-auto text-justify">
              ...
              <li className="list-disc">
                ...
                correspondiente controlador, permitiendo URL semánticas.
              </li>
              <li className="list-disc">
                {" "}
                Las URL semánticas se indexan mejor en los buscadores, siendo
                más adecuadas para el posicionamiento web.
              </li>
              <li className="list-disc">
                {" "}
                Recomendable para el diseño de aplicaciones web compatibles con
                grandes equipos de desarrolladores y diseñadores web que
                necesitan gran control sobre el comportamiento de la aplicación.
              </li>
            </ul>
          </div>
          <div>
          ...
          <img
            ...
            alt="MVC"
            className="w-11/12 mx-auto pt-3 pb-8"
          />
        </div>
      </div>
    </Layaout>
